#!/usr/bin/env python3
"""Run ONE problem of browse_comp through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/browse_comp"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one browse_comp problem via TrustedRouter")
