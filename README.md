...
A benchmark for evaluating agents' ability to browse the web. The dataset consists of
challenging questions that generally require web-access to answer correctly.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/browse_comp`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/browse_comp) |
| Group | Assistants |
| Total samples | 1,266 |
| Execution class | `sandbox-local` |
| Cost class | `high` |
| Flags | sandboxed · needs internet · fast |
| Tags | Agent |
...
- `direct_url` — `https://openaipublic.blob.core.windows.net/simple-evals/browse_comp_test_set.csv` (pinned)
